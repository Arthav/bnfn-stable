          ...
          <Card className="mt-4 border-none bg-background/60 dark:bg-default-100/50 backdrop-blur-lg shadow-sm">
            <CardBody className="gap-6 p-6">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Input label="First Name" defaultValue="Tony" variant="bordered" />
                    <Input label="Last Name" defaultValue="Reichert" variant="bordered" />
                    <Input label="Email" defaultValue="tony.reichert@example.com" variant="bordered" className="md:col-span-2" />
                    <div className="md:col-span-2">
                        <label className="text-small text-default-500 mb-1 block">Bio</label>
